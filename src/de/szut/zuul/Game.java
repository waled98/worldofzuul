...
public class Game {
    ...
    private void createRooms() {
        ...
        player.setCurrentRoom(marketsquare); // start game on marketsquare
    }
    ...
    private String takeItem(Command command) {
        if(player.getCurrentRoom().items.containsKey(command.getSecondWord())) {
    ...
    private String dropItem(Command command) {
        if(player.inventory.contains(player.GetItem(command.getSecondWord()))) {
